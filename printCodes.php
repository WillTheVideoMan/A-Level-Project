...
<body>
	...
	<div class="codeContainer">
		<img src="https://api.qrserver.com/v1/create-qr-code/?size=320x320&data=<?php echo $stuCode;?>" width=3 20px height=3 20px>
		<p>
			<?php echo $stuCode;?>
		</p>
	</div>
	...
	{	
		...
		{?>
	<div class="codeContainer">
		<img src="https://api.qrserver.com/v1/create-qr-code/?size=320x320&data=<?php echo $dataRow['studentCode'];?>" width=3 20px height=3 20px>
		<p>
